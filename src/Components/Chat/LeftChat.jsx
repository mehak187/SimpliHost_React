...
const ChatPerson = ({ name, message, time, isActive, onClick }) => (
    <div
        className={`d-flex justify-content-between mt-2 chat-person p-2 ${isActive ? 'active-chat' : ''}`}
        onClick={onClick}
    >
        <div className="d-flex align-items-center">
            <Badge
                ...
                badgeContent={
                    <SmallAvatar alt="Remy Sharp" src={BadgeImg} />
                }
            >
            ...
            <div className="ps-2">
                <div className="d-flex align-items-center">
                    ...
                    <img src={Language} alt="" className="md-img rounded-circle shadow ms-2" />
                </div>
            ...
            <div className="d-flex justify-content-between p-2">
                ...
                <div className="dropdown">
                    <button
                        ...
                        aria-expanded="false"
                    >
                        <CiFilter className="text-secondary me-2" /> Filter <FaCaretDown className="text-secondary ms-3" />
                    </button>
                    <ul className="dropdown-menu w-100">
                        <li><p className="dropdown-item">Option 1</p></li>
                        <li><p className="dropdown-item">Option 2</p></li>
                        <li><p className="dropdown-item">Option 3</p></li>
                    </ul>
                </div>
            </div>
            ...
            <CustomTabPanel className='p-2' value={value} index={0}>
                <form>
                    <div className="border border-dark rounded-pill bg-white d-flex p-2">
                        <label htmlFor="searching" className="bg-blue text-white rounded-circle p-1 d-inline-flex">
                            <CiSearch />
                        </label>
                        <input
                            type="search"
