    ...
    <div className="container">
      <div className="row align-items-center">
        <div className="col-xl-5">
          ...
          <div className="mt-4">
            <Link to="/pricing" className="text-decoration-none more-btn px-5 py-2 fw-semi">
              Learn More
            </Link>
          </div>
        </div>
            ...
            <div className="col-md-6 d-flex flex-column mt-3 mt-md-0">
              <div className="simplified-price p-5 flex-grow-1 d-flex flex-column">
                ...
                <div className="mt-auto">
                  <Link to="/pricing" className="text-decoration-none simplified-btn d-block text-center fw-semi">
                    Get Your Price
                  </Link>
                </div>
              </div>
...
data-bs-target="#signupModal" className="text-decoration-none text-white fullyfeature-btn d-block text-center fw-semi">
                    Sign Up Now
                  </Link>
                </div>
              </div>
