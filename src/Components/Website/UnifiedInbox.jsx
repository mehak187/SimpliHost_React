        ...
        <div className="container">
            <div className="row align-items-center">
                <div className="col-lg-6 ">
                    <div className="">
                        <h1 className="fw-bold">Let <span className="litblue">SimpliHost</span> Make Guest
                            Communication a Breeze</h1>
                        <p className="mb-0 comm-para">Automate your guest messaging and save time with pre-built responses,
      ...
      <section className="effort-sec py-4 py-lg-5">
        <div className="container">
            <div className="text-center">
                <h2 className="fw-bold">Effortless Guest Messages, Just a Tap Away!</h2>
                <div>
                    <img src={effortless} alt="pic" className="img-fluid" />
                </div>
                <p className="mb-0 effort-para">SMS? You bet. Templates for quick replies? Absolutely. Emojis and
...
and automatic triggers to ensure you never miss a beat. SimpliHost  makes every interaction smoother and smarter!"
      ...
      />
        ...
        <div className="container">
            <div className="row">
                <h2 className="fw-bold text-center mb-5">Get to Know <span className="litblue">Simplihost</span> Unified Inbox
                </h2>
                <div className="col-lg-4 col-sm-6 mb-4">
                    <div className="bg-litgrey p-4 rounded-4 h-100 d-flex flex-column border border-5 border-white">
                        <div className="d-flex align-items-center">
                            <div
                                className="bg-blue d-flex justify-content-center align-items-center p-3 rounded-4 coreF-card1 mb-4">
                                <img src={filter} alt="pic" className="" />
                            </div>
                            <h5 className="ms-3 fw-semi">Filter/Search Your Messages</h5>
                        </div>
                        <div className="">
                            <p className="mb-0">Need to track down a message? No problem! Filter
                ...
                <div className="col-lg-4 col-sm-6 mb-4">
                    <div className="bg-litgrey p-4 rounded-4 h-100 d-flex flex-column border border-5 border-white">
                        ...
                        <div className="">
                            <p className="mb-0">Answer in a flash using our pre-built templates! No
                ...
                <div className="col-lg-4 col-sm-6 mb-4">
                    <div className="bg-litgrey p-4 rounded-4 h-100 d-flex flex-column border border-5 border-white">
                        ...
                        <div className="">
                            <p className="mb-0">Create automated guest messages triggered by
