...
function ProfileInformation() {
  return (
    <div>
      <h2 className="fs-6 mb-0 text-capitalize text-blue2 fw-bold mt-3 mt-sm-0">About your profile</h2>
      ...
      <div className="mt-3 py-3 border border-1 rounded-3">
        <h3 className="fs-6 px-3 text-capitalize text-blue2 fw-bold">Personal Information</h3>
