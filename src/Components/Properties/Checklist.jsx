    ...
    <div>
      <div className='row align-items-center justify-content-between'>
        ...
        <div className="d-sm-flex col-xl-6 col-12 mt-3 mt-xl-0 justify-content-end align-items-center">
           <Link to="" className="px-sm-4 mt-3 me-2 mt-sm-0 px-3 border-blue text-center d-block d-sm-inline text-blue rounded-3 opacity-hover bg-white text-decoration-none py-2">Create New</Link>
        </div>
    </div>
        ...
        <table className="table">
          <thead className="">
            <tr className="align-middle">
              ...
              <th className="small fw-semi text-black text-nowrap text-center">Number of items</th>
          ...
          <tbody>
            {DataCollection.map((data) => (
              <tr key={data.id} className="align-middle">
                ...
                <td className="small text-black text-nowrap">{data.checklistType}</td>
                <td className="small text-black">{data.shared}</td>
                <td className="small text-black text-center">{data.numberOfitems}</td>
