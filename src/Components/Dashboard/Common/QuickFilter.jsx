                ...
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        <div className="modal-header">
                            ...
                            <button type="button" className="bg-transparent border-0 text-danger fs-4" data-bs-dismiss="modal" aria-label="Close">
                                <IoMdCloseCircle />
                            </button>
                        </div>
                        ...
                        <div className="modal-footer d-flex align-items-center justify-content-between">
                            <button type="button" className="bg-transparent border-0 text-blue text-decoration-underline" data-bs-dismiss="modal">Clear</button>
