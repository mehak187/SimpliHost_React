...
function Multi() {
  useEffect(() => {
    ...
    // Helper function to strip time and only compare dates (ignoring time zones)
    const toDateOnly = (isoString) => {
      return isoString.split("T")[0]; // Returns date portion only (YYYY-MM-DD)
    };
