  ...
  return (
    <div className="setting-bg rounded-3">
      ...
      <div className="mt-3 py-3 px-3 rounded-3">
        <h3 className="fs-5  text-capitalize text-black fw-semi">Global Preferences</h3>
          ...
          <div className="py-3 border-bottom border-1">
            <h6 className="text-blue2 fw-bold fs-6">Initial # of Listings to Display on Calendar</h6>
