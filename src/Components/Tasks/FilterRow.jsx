  ...
  return (
    <div className='row align-items-center justify-content-between'>
        ...
        <div className="d-sm-flex col-xl-6 col-12 mt-3 mt-xl-0 justify-content-end align-items-center">
           ...
           <Link to="/admin/add-tasks" className="px-sm-4 mt-3 mt-sm-0 px-3 border-blue text-center d-block d-sm-inline text-blue rounded-3 opacity-hover bg-white text-decoration-none py-2">Add Task</Link>
        </div>
    </div>
  )
}
