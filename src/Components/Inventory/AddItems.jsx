    ...
    <section>
        ...
        <form action="inventory">
            ...
            <div className="col-lg-12 col-xl-10 col-xxl-8">
              <div className="row">
                <div className="col-lg-6 mt-3">
                  <label htmlFor="TaskName" className='fw-semi'>Item Name</label><br />
                  <input type="text" id='TaskName' className='inputstyle focus-none' placeholder='Type name here'/>
                </div>
                <div className="col-lg-6 mt-3">
                  <label htmlFor="TaskName" className='fw-semi'>Item Description</label><br />
                  <input type="text" id='TaskName' className='inputstyle focus-none' placeholder='Type description here'/>
                </div>
                <div className="col-lg-6 mt-3">
                  <label htmlFor="Property" className='fw-semi'>Type</label><br />
                ...
                <div className="col-lg-6 mt-3">
                  <label htmlFor="TaskType" className='fw-semi'>Item Size</label><br />
          ...
          <h2 className='fw-semi fs-5 mt-4'>Inventory Stock</h2>
                <div className="col-lg-6 mt-3">
                  <label htmlFor="count" className='fw-semi'>Initial Count</label><br />
                  <input type="text" id='count' placeholder="Type here" className='inputstyle focus-none'/>
                </div>
                <div className="col-lg-6 mt-3">
                  <label htmlFor="TaskType" className='fw-semi'>Vendors</label><br />
                  <select name="TaskType" id="TaskType" className='inputstyle focus-none'>
                ...
                <div className="col-lg-6 mt-3">
                  <label htmlFor="purchaseLink" className='fw-semi'>Purchase Link</label><br />
                  <input type="text" id='purchaseLink' placeholder="Type here" className='inputstyle focus-none'/>
                </div>
                <div className="col-lg-6 mt-3">
                  <label htmlFor="lastDate" className='fw-semi'>Last Purchase Date</label><br />
                  <input type="date" id='lastDate' className='inputstyle focus-none'/>
                </div>
                <div className="col-12 mt-3">
                  <div className="d-flex align-items-center">
                  <label htmlFor="Capture" className=" me-3">Low Stock alert</label>
                ...
                <div className="col-lg-6 mt-3">
                 <div className="d-flex align-items-center">
                    <label htmlFor="lastDate" className='fw-semi me-2'>Send alert when stock is at alert or below</label><br />
                    <input type="number" id='lastDate' className='inputstyle w-50 focus-none'/>
                 </div>
                </div>
